...
const JobListingsMobile = ({jobs=[]}) => {
    ...
    return (
        <div className="max-w-xl py-4 mx-auto" style={{display:'flex',flexDirection:'row',justifyContent:'space-between'}}>
                ...
                {rowChanges.length>0 && rowChanges.map((job, index) => (
                    <div onClick={()=>{
                        ...
                        // className="bg-KCTBS-yellow-throw p-4 rounded shadow mb-4"
                         className="bg-white p-4 rounded shadow mb-4 border border-KCTBS-blue"
                    ...
                    >
                        ...
                        <div style={{width:'100%'}}>
                            <div className="flex justify-between">
                                ...
                                <span style={{backgroundColor:'red',height:'30px'}} className="text-white bg-red text-bold border border-red-500 px-2 py-1 rounded">HOT</span>
                            </div>
